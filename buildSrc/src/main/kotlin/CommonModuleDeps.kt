...
fun DependencyHandler.addTestDependencies() {
    ...
    testImplementation(Deps.Testing.MOCKITO_INLINE)
    androidTestImplementation(Deps.Testing.MOCKITO_ANDROID)
    testImplementation(Deps.Testing.MOCKITO_KOTLIN)
    testImplementation(Deps.Testing.ANDROID_X_CORE_TESTING)
    testImplementation(Deps.Testing.ANDROID_X_TEST_RULES)
}
